function Section() {
    ...
    return (
        ...
        <>
            ...
            <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src="https://img.freepik.com/free-vector/free-delivery-logo-with-bike-man-courier_1308-48827.jpg?w=1380&t=st=1665408885~exp=1665409485~hmac=11c0abb3ba42448aaee6c965742011f90c4dd09c274c5fa92325feeff4d72aeb" className="d-block w-100" width="100%" height="550px" />
                    </div>
                    <div className="carousel-item">
                        <img src="https://img.freepik.com/premium-vector/food-delivery-mobile-phone-online-food-order-e-commerce-concept_226040-35.jpg?w=2000" className="d-block w-100" width="100%" height="550px" />
                    </div>
                    <div className="carousel-item">
                        <img src="https://img.freepik.com/premium-vector/set-food-social-media-templateswith-black-white-yellow-color_241598-10.jpg?w=1380" className="d-block w-100" width="100%" height="550px" />
                    </div>
                </div>
            ...
            <img style={{ paddingLeft: "450px" }} src="https://media.istockphoto.com/vectors/grunge-black-on-time-delivery-word-sqaure-rubber-seal-stamp-on-white-vector-id1364591618?s=612x612" class="img-fluid" />


            <div className="row row-cols-1 row-cols-md-3 g-4">
                <div className="col">
                    <div className="card h-100">
                        <img src="https://media.istockphoto.com/photos/juicy-hamburger-on-white-background-picture-id1206323282?k=20&m=1206323282&s=612x612&w=0&h=yatlq6BHRCCvoTzFZLSwaJc0O8Quct_tRPWtH0dj9Fc=" className="card-img-top"/>
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="https://media.istockphoto.com/photos/delicious-vegetarian-pizza-on-white-picture-id1192094401?k=20&m=1192094401&s=612x612&w=0&h=jesvXuPyvqM36GQ5QEvJrL3QZjK6YKsziUUF3ZbW0gw=" className="card-img-top"  />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="https://media.istockphoto.com/photos/punjabi-samosa23-picture-id502663991?k=20&m=502663991&s=612x612&w=0&h=jC4KxvXhgWxueNgtMJar4BYTcVN_NQH1k-qVMsJ_eCE=" className="card-img-top"  />
                        <div className="card-body">
